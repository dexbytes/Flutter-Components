...
class SelectedPhotoGallery extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SelectedPhotoGallery(
        /*controllerImageSelectState: this.controllerImageSelectState*/);
  }
}

class _SelectedPhotoGallery extends State<SelectedPhotoGallery> {
  ...
  _SelectedPhotoGallery({this.controllerImageSelectState});
