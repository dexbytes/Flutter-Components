...
class PickerCustom extends StatefulWidget {
  ...
  PickerCustom({
    ...
    this.selectionOverlay = const PickerDefaultSelectionOverlayCustom(),
    bool looping = false,
  ...
  ///
  /// If unspecified, it defaults to a [PickerDefaultSelectionOverlayCustom]
...
/// To achieve the same effect using [PickerDefaultSelectionOverlayCustom],
...
class PickerDefaultSelectionOverlayCustom extends StatelessWidget {
  ...
  const PickerDefaultSelectionOverlayCustom({
    Key key,
    this.background = CupertinoColors.tertiarySystemFill,
    this.capLeftEdge = false,
    this.capRightEdge = false,
  ...
  /// The color to fill in the background of the [PickerDefaultSelectionOverlayCustom].
    ...
    return isAndroid
        ? Container(
            margin: EdgeInsets.only(
              ...
              right:
                  capRightEdge ? _defaultSelectionOverlayHorizontalMargin : 0,
            ),
        ...
        : Container(
            ...
            decoration: BoxDecoration(
              ...
              color: Color(0x00FFFFFF),
                ...
                border: Border(
                  */ /*left: BorderSide(
                        width: 1.0, color: Color.fromARGB(255, 252, 109, 38)),*/ /*
                  top: BorderSide(
                      width: 1.0, color: Color.fromARGB(255, 30, 198, 89)),
                  bottom: BorderSide(
                      width: 1.0, color: Color.fromARGB(255, 30, 198, 89)),
                  */ /* right: BorderSide(
                        width: 1.0,
                        color: Color.fromARGB(255, 252, 109, 38))*/ /*
                ), //Border.all
                borderRadius: BorderRadius.all(
                  Radius.circular(5),
                ),
                color:
                    CupertinoDynamicColor.resolve(Color(0x00FFFFFF), context))*/
            ,
            /*decoration: BoxDecoration(
              borderRadius: BorderRadius.horizontal(
                left: capLeftEdge ? radius : Radius.zero,
...
class _RenderCupertinoPickerSemantics extends RenderProxyBox {
  ...
  void _updateController(
      FixedExtentScrollController oldValue, FixedExtentScrollController value) {
